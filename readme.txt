...
Tags: activity log, audit log, audit trail, security audit log, user log
Tested up to: 6.6
Stable tag: 1.2.12
License: GPLv2
...
== Upgrade Notice ==
= 1.2.12 =
Improved compatibility with WP Admin Audit extensions, logging optimizations, Tested with WP v6.6

= 1.2.11 =
Fix to not show column selector in screen options, dashboard performance optimization

= 1.2.10 =
Fix recording of bulk updates (of plugins and themes), UI improvements, Avoid PHP warnings, Updated PUC library, Tested with WP v6.5
